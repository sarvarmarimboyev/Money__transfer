...
import riaData from "../data/en.json"; // Update the path to your JSON file
import "./header.css"

export default function RIA({ selectedCountry, selectedCurrency, enteredValue }) {
  const riaInfo = riaData[1];

  const isUsdOrEurSelected = selectedCurrency === "usd" || selectedCurrency === "eur";
  const tarifInfo = riaInfo.tarifs.find((tarif) =>
  ...
  return (
    <div className="list">
      <img src={riaInfo.logo} alt={riaInfo.company_name} />
