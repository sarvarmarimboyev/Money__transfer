...
import uniSteamData from "../data/en.json"; // Update the path to your JSON file
import "./header.css"

export default function UniSteam({
  selectedCountry,
  selectedCurrency,
  enteredValue,
}) {
  const uniSteamInfo = uniSteamData[2];

  const isUsdOrEurSelected =
    selectedCurrency === "usd" || selectedCurrency === "eur";
  const tarifInfo = uniSteamInfo.tarifs.find((tarif) =>
  ...
  return (
    <div className="list" >
      <img src={uniSteamInfo.logo} alt={uniSteamInfo.company_name} />
