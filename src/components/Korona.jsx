...
import koronaData from "../data/en.json"; // Update the path to your JSON file
import "./header.css"

export default function Korona({ selectedCountry, selectedCurrency, enteredValue }) {
  const koronaInfo = koronaData[4];

  const isUsdOrEurSelected = selectedCurrency === "usd" || selectedCurrency === "eur";
  const tarifInfo = koronaInfo.tarifs.find((tarif) =>
  ...
  return (
    <div className="list" >
      <img src={koronaInfo.logo} alt={koronaInfo.company_name} />
